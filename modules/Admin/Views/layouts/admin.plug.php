...
<body class="h-full text-slate-900 selection:bg-indigo-100 selection:text-indigo-700 overflow-hidden">
    ...
    <div class="flex h-full">
        <!-- Sidebar -->
        <aside id="adminSidebar" class="fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-slate-100 transition-transform duration-300 ease-in-out transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0">
            <div class="flex flex-col h-full bg-white">
                ...
                <div class="p-6">
                    <a href="{{ route('welcome') }}" class="flex items-center gap-3 group">
                        ...
                        <div class="flex flex-col">
                            <span class="font-bold text-xl tracking-tight text-slate-800 brand-font leading-none">Plugs</span>
                            <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">Admin Central</span>
                        </div>
                    </a>
                </div>
                ...
                <nav class="flex-1 px-4 py-4 space-y-1.5 overflow-y-auto custom-scrollbar">
                    ...
                    <a href="/admin" class="sidebar-link flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-xl transition-all duration-200 text-slate-600 hover:bg-slate-50 group sidebar-active">
                    ...
                    <a href="/admin/users" class="sidebar-link flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-xl transition-all duration-200 text-slate-600 hover:bg-slate-50 group">
                        <svg class="w-5 h-5 opacity-70 group-hover:text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="/admin/modules" class="sidebar-link flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-xl transition-all duration-200 text-slate-600 hover:bg-slate-50 group">
                        <svg class="w-5 h-5 opacity-70 group-hover:text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="/admin/settings" class="sidebar-link flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-xl transition-all duration-200 text-slate-600 hover:bg-slate-50 group">
                        <svg class="w-5 h-5 opacity-70 group-hover:text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-4 border-t border-slate-100">
                    <a href="/admin/profile" class="flex items-center gap-3 p-3 rounded-2xl bg-slate-50 hover:bg-slate-100 transition-colors group">
                        ...
                        <div class="flex flex-col overflow-hidden">
                            ...
                            <span class="text-[10px] text-slate-400 font-medium truncate">View Profile</span>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="hidden sm:block">
                        ...
                        <div class="flex items-center gap-2 mt-0.5">
                            ...
                            <div class="px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-600 text-[10px] font-bold uppercase tracking-wider">Active</div>
                        </div>
                    </div>
                </div>
