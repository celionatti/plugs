        ...
        <aside id="adminSidebar" class="fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-slate-100 transition-transform duration-300 ease-in-out transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0">
            <div class="flex flex-col h-full bg-white">
                ...
                <nav class="flex-1 px-4 py-4 space-y-1.5 overflow-y-auto custom-scrollbar">
                    ...
                    <a href="#" class="sidebar-link flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-xl transition-all duration-200 text-slate-600 hover:bg-slate-50 group">
                        <svg class="w-5 h-5 opacity-70 group-hover:text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
