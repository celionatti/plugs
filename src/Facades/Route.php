 ...
 * @method static \Plugs\Router\Route view(string $uri, string $view, array $data = [])
 * @method static \Plugs\Router\Route redirect(string $uri, string $destination, int $status = 302)
