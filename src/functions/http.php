...
if (!function_exists('http')) {
    function http(?string $baseUri = null): HTTP
    {
        $http = HTTP::make();
...
if (!function_exists('http_get')) {
    ...
    {
        return HTTP::make()->get($url, $query);
    }
}
...
if (!function_exists('http_post')) {
    ...
    {
        return HTTP::make()->post($url, $data);
    }
}
...
if (!function_exists('http_patch')) {
    ...
    {
        return HTTP::make()->patch($url, $data);
    }
}
...
if (!function_exists('http_delete')) {
    ...
    {
        return HTTP::make()->delete($url, $data);
    }
}
