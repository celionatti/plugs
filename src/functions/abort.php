...
/* |-------------------------------------------------------------------------- | Abort Helper Functions |-------------------------------------------------------------------------- | | Convenient shortcuts for throwing HTTP exceptions. These stop execution | immediately and let the exception handler render the appropriate response. | | Usage: |   abort(404); |   abort(403, 'You shall not pass'); |   abort_if($user->isBanned(), 403, 'Account suspended'); |   abort_unless(auth()->check(), 401); */
