                ...
                <?php if (empty($profiles)): ?>
                    <tr>
                        <td colspan="7" style="text-align: center; padding: 4rem 2rem;">
                            ...
                            <p style="color: var(--text-muted); font-size: 0.85rem; margin-top: 0.5rem;">Make some requests
                    ...
                    <tr class="profile-row" onclick="window.location.href='/debug/performance/<?= $p['id'] ?>'">
                        ...
                        <td class="hide-tablet">
                            <div style="font-size: 0.85rem; color: var(--text-primary);">
                                <?= date('H:i:s', $p['timestamp']) ?></div>
                            <div style="font-size: 0.7rem; color: var(--text-muted);"><?= date('M d, Y', $p['timestamp']) ?>
                            </div>
                        </td>
