...
<div class="glass-panel" style="overflow: hidden;">
    <div class="tabs-header">
        ...
        <button class="tab-btn" data-tab="config-tab">
            <svg class="tab-icon" width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="code-pattern" style="position: relative;">
                                    ...
                                    <?php if (strlen($sql) > 160): ?>
                                        <button data-action="show-sql" data-id="<?= md5($sql) ?>"
                                            data-sql="<?= htmlspecialchars($sql, ENT_QUOTES) ?>" class="btn-view-full"
            ...
            <div class="glass-panel" style="padding: 1.5rem; background: rgba(0,0,0,0.2);">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr style="border-bottom: 1px solid var(--border-glass);">
                        ...
                        <td style="padding: 0.75rem 0; text-align: right; font-family: 'JetBrains Mono', monospace;">
                            <?= PHP_VERSION ?>
                        </td>
                    </tr>
                    <tr style="border-bottom: 1px solid var(--border-glass);">
