...
class MakeEcommerceModuleCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $filesToGenerate = [
            ...
            'Requests/ProductRequest.php.stub' => 'Requests/ProductRequest.php',
            'Requests/CategoryRequest.php.stub' => 'Requests/CategoryRequest.php',
            'Requests/BrandRequest.php.stub' => 'Requests/BrandRequest.php',
