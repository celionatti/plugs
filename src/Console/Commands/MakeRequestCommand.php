...
class MakeRequestCommand extends Command
{
    ...
    private function generateRequestClass(string $name, array $options): string
    {
        ...
        $authorize = $options['auth'] ? $this->buildAuthorize() : $this->buildSimpleAuthorize();
...
PHP;
    ...
    private function buildAuthorize(): string
    {
        return <<<'PHP'
    /**
...
PHP;
    ...
    private function buildSimpleAuthorize(): string
    {
        return <<<'PHP'
    /**
     * Determine if the user is authorized to make this request
