...
<div class="mb-10">
    <div class="flex items-center gap-3 mb-4">
        <a href="/admin/users" class="p-2 rounded-xl bg-white border border-slate-200 text-slate-500 hover:text-indigo-600 hover:border-indigo-200 transition-all">
...
<div class="w-full">
    ...
    <div class="flex items-center justify-end gap-4 mt-8 pb-12">
        ...
        <a href="/admin/users/{{ $user->id }}/edit" class="px-8 py-3.5 rounded-2xl bg-black text-white font-bold hover:bg-slate-800 shadow-xl shadow-black/10 transition-all active:scale-95">
            Edit User
        </a>
