...
<!-- Active Theme Banner -->
<div class="mb-8 p-6 rounded-3xl bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border border-indigo-100 dark:border-indigo-800">
    <div class="flex items-center gap-4">
        <div class="w-12 h-12 rounded-2xl gradient-bg flex items-center justify-center shadow-lg shadow-primary">
            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
            </svg>
        </div>
        <div>
            <p class="text-xs font-bold text-primary dark:text-indigo-400 uppercase tracking-widest">Active Theme</p>
...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 pb-20">
    ...
    <div class="group relative bg-white dark:bg-slate-900 rounded-3xl shadow-sm border {{ $theme['active'] ? 'border-indigo-300 dark:border-primary ring-2 ring-primary' : 'border-slate-100 dark:border-slate-800' }} overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
        <!-- Theme Preview Area -->
        <div class="relative h-44 bg-gradient-to-br {{ $theme['active'] ? 'from-indigo-100 via-purple-50 to-violet-100 dark:from-indigo-900/40 dark:via-purple-900/30 dark:to-violet-900/40' : 'from-slate-100 via-slate-50 to-slate-100 dark:from-slate-800 dark:via-slate-800/50 dark:to-slate-800' }} flex items-center justify-center overflow-hidden">
            ...
            <div class="absolute top-4 right-4">
                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-primary text-white text-xs font-bold shadow-lg shadow-primary">
        ...
        <div class="p-6">
            ...
            <!-- Action -->
            @if($theme['active'])
            <div class="flex items-center gap-2 text-sm font-bold text-primary dark:text-indigo-400">
